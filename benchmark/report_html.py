...
<main>
  ...
  <section class="card">
    ...
    <p class="sub">Cell = <b>A_full − baseline</b> delta. Teal = A_full leads, amber = baseline leads,
      gray ≈ tie. Hover a cell for the two raw scores.</p>
    <div class="legend">
  ...
  <p class="foot">Generated by <code>benchmark/report_html.py</code> from {html.escape(filename)}.
    Axis meanings + the "why" behind a number: run the scorer with <code>--full</code>.</p>
</main>
</body>
</html>
"""
